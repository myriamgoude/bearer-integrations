...
export class InvoicesDisplay {
    ...
    render() {
        ...
        return (
            <div class="content">
                {this.onDelete ? <span class="remove icon-inline icon-after" onClick={(event) => {this.handleRemovalClick(event)}}>REMOVE<IconTrash/></span> : null}
                <ol>
                    {this.items.map(invoice => {
                        return (
                            <li class="list-item">
                                <div class="list-heading">
                                    <span class={"status-box" + " " + invoice.status}>
                                ...
                                <div class="actions">
                                    <a href={invoice.invoice_pdf} target="_blank" class="download-link icon-inline icon-before"><IconDownload />Download</a>
                                </div>
                            </li>
                        )
                    })
