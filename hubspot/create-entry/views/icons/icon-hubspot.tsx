export default () => (
    <svg id="Outlines_-_Full_Color" data-name="Outlines - Full Color" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 242.04 257"><defs>
        <clipPath id="clip-path"><rect class="cls-1" x="42.87" y="46.9" width="156.42" height="163.35"/></clipPath>
    </defs><title>sprocket-web-color_sprocket-black-web</title><g id="Sprocket"><g class="cls-2"><g class="cls-2">
